...
- **Constitutional boundedness.** Every agent has purpose bounds, resource caps, and a sunset date specified in advance.
...
- **Local safeguard stack** for community-run models and detectors: GPT-OSS and gpt-oss-safeguard for bring-your-own-policy moderation, and ROOST-style open tools for detecting child-safety harms — without centralising authority.
...
- **To Attentiveness (Pack 1):** retired agents gift maps, evals, and operational records to the commons — better first looks next time.
