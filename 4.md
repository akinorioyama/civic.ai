...
- **Weaponised appeals.** Adversaries flood appeals or strategically trigger pauses to disrupt service; synthetic appellants can swamp the same repair channels at AI scale. Fix: Require authenticated standing (not public identity) for pause triggers and appeal routes; rate-limit by community; audit trails that separate genuine standing from generated proxies; preserve priority access for those directly affected.
