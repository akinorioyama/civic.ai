...
對仁工智慧來說，含意很直接。地神（Kami——先有這個詞，縮寫 **K**nowledge 知識、**A**rtefact 產物、**M**anagement 管理、**I**ntelligence 智慧是後來才補上的）不應該是一個在各領域遊走的小型主權心智。它應該是一個專家：擅長某一類社群工作，能在工作改變時被替換，且不能把在地成功轉化成普遍授權。
