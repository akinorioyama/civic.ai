...
大多數 AI「對齊」工作——也就是讓 AI 的行為符合人類價值的努力——都試圖由上而下地解決那些價值問題：寫出更好的規則、推斷更好的偏好、訓練更好的模型。這些工具很重要，但光靠它們並不夠。關懷六力從別的地方出發。它追問的是：誰被聽見、誰負責、失敗如何被修復、以及系統何時應該退場。對齊不是一次解完；它必須在公共程序中持續維護——一套可問責的公民程序，書中稱之為「程序對齊」（alignment-by-process）。
