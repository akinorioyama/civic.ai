...
**Verified execution rate** is the headline public measure for competence. The public question is what share of audited decisions or releases pass guardrails, include a usable trace, and stay inside release bounds. Supporting diagnostics include guardrail integrity, trace completeness, canary health, and audit overturn rate. The rate rises only when traces are reconstructable by an independent auditor and canaries are genuinely representative — never when the system passes on easy cases and calls the ceremony proof. See [Measures](/measures/).
