...
- **公開工作過程——以小冊子呈現。** 把 AI 的產出當成小冊子（brochure）來呈現：可共享、可編輯的產物，讓每項主張都連結到來源並標示分歧，而不是把分歧抹平成虛假共識的私下聊天回覆。
...
輔助診斷包括受影響者覆蓋率，以及最少被聽見與最多被聽見群體之間的聲量落差，並對照作為證據產物的搭橋地圖一併解讀。落差的縮小，只有在最少被聽見的群體於紀錄中獲得真正立足地位時才算數——絕不能靠把他們的分歧平均掉來達成。詳見[衡量指標](/tw/measures/)。
